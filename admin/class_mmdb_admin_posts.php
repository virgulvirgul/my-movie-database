...
class MMDB_Admin_Posts {
	...
	public function __construct($type_name, $type_slug, $type_plural) {
		...
		add_action('admin_head', array($this, 'mmdb_posts_admin_menu_icons_css'));
		add_action('init', array($this, 'mmdb_change_posts_object_label'));
		add_action('admin_menu', array($this, 'mmdb_change_posts_menu_label'));
	}
