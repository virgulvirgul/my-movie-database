...
class My_movie_database {
	...
	private function load_dependencies() {
		 ...
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/lib/class_wp_custom_post_types.php';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin->make_custom_post_types();		
		$plugin_admin->edit_wp_posts();
		$plugin_admin->make_post_meta_boxes();
