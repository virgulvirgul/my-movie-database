<?php
/**
 * 	This class handles all the data you can get from a TVShow job
 *
...
class TVShowJob {
    ...
    /** 
     *  Get the TVShow's title of the job
     *
     *  @return string
     */
    ...
    /** 
     *  Get the TVShow's original title of the job
     *
     *  @return string
     */
    ...
    /** 
     *  Get the TVShow's release date of the job
     *
     *  @return string
     */
